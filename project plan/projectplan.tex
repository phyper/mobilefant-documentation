...
We have several roles and one person can have several roles. The roles are:
...
\hline 
PM, RE & Benjamin Behm & benjamin.behm\#aalto.fi & Organizing the 
work, removing impediments, documenting, process supervising, eliciting requirements, coding & - \\ 
\hline
AR, RE & Harri Lampi & harri.lampi\#aalto.fi & Architectural design, eliciting requirements & - \\ 
\hline
QA, RE & Matias Kuusela & matias.kuusela\#aalto.fi & QA &  \\ 
\hline
Dev, AR & Aleksi Hoffman & aleksi.hoffman\#aalto.fi & & \\
\hline
Dev & Miro Vilkki & miro.vilkki\#aalto.fi &  & \\
\hline
Dev & Rolle Saarinen & rolle.saarinen\#aalto.fi &  & \\
\hline
Dev & Janne Gröndahl & janne.grondahl\#aalto.fi & & \\
\hline
Dev & Janne Kajovuori & janne.kajovuori\#aalto.fi & & \\
\hline
Dev & Joakim Kronqvist & joakim.kronqvist\#aalto.fi & & \\
\hline
...
the main functionalities of its cloud version and fulfill customer's vision of the product. Other high level goals are identified, and these are presented in Table~\ref{table:Projectgoals}.
...
We are working iteratively during the course. The idea is to build the product incrementally and iteratively. We will be using an agile software development method called Scrum. Its focus is to provide guidelines that enable flexible way of working and allow the development team to react to changes in requirements faster than traditional development frameworks.

The course is divided into three phases (Planning, Implementation 1 and Implementation 2). Planning phase has two 2-weeks sprints. Implementation 1 and Implementation 2 have both 3 sprints, two 2-weeks sprints and one 3-weeks sprint. It need to be remembered that there are exam weeks in Finland, so those affect the times when students are willing to work for the project.
...
The groups' time tracking will be applied in Agilefant. The group should follow 
