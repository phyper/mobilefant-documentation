...
\centering 4 & To produce an application that is an easy to develop further &
...
story points following the pattern of fibonacci numbers. Possible story points
...
Flowdock is agreed to be used as a primary communication channel.Aalto provides
...
Requirements are specified in a backlog grooming session at the end of each
