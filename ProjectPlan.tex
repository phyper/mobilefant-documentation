...
We need mobile phones to test the application. Customer has promised to deliver 
some test phones, but a wide range of different phones cannot be guaranteed. 
The CSE department can borrow desktop computers to our group with virtual 
machines installed. These computers need to be set up to our team room A243. 
This room will be shared with another project group (\#15 - TrafficSense) so we 
need to be careful what we leave into that room. Personal goods should not be 
left to the room for own sake.
...
would have an improved version of the application ready to release.
...
sprint planning is presented in Table 3.
...
Time tracking will be done using Agilefant. Everyone should log used hours 
directly to the story or task the person has been doing.
